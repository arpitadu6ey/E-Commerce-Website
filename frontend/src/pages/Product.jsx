    ...
    <div className='border-t-2 border-gray-100 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border border-gray-200 px-6 py-6 text-sm text-gray-500'>
          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas nostrum ipsum itaque obcaecati accusantium, enim deleniti tempore nesciunt incidunt pariatur fugit. Sunt ut quo explicabo perferendis quisquam qui assumenda velit.</p>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore quibusdam in necessitatibus reiciendis repellendus minima eaque distinctio iure ea, corporis debitis magnam autem natus possimus tempora quidem quas, sequi aliquam!</p>
        </div>
      </div>
